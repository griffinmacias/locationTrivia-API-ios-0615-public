...
- (id) initWithName:(NSString *)name Latitude:(NSNumber *)latitude Longitude:(NSNumber *)longitude Id:(NSNumber *)locationID;
{
    self = [super init];
    if (self) {
        _name=name;
...
- (instancetype)init
{
    return [self initWithName:@"" Latitude:@0 Longitude:@0 Id:@0];
}
